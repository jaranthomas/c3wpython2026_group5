...
def game_loop():
    ...
    # Create the player
    player = Player(100, 400, "player.png")
    ...
    # Basic platforms
    platforms = [
        pygame.Rect(0, 550, WIDTH, 50),
        pygame.Rect(250, 450, 200, 25),
        pygame.Rect(550, 350, 150, 25)
    ]
    ...
    while running:
        ...
        # Player movement
        movement.handle_input(player)
        movement.update(player, platforms)
